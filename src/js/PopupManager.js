  ...
  constructor(scene, x, y) {
    ...
    const html = `           
        <div class="uiverse-pixel-card">
          ...
          <div class="card">
            <div class="card-image"><img src="${scene.textures.getBase64('symbol1')}" alt=""></div>
          ...
          <div class="card">
            <div class="card-image"><img src="${scene.textures.getBase64('symbol2')}" alt=""></div>
            <div class="category"> SPEEDER </div>
            <div class="heading">5.&nbsp9160<br>4.&nbsp3660<br>3.&nbsp1370<br>2.&nbsp&nbsp&nbsp&nbsp&nbsp</div>
          </div>
          <div class="card">
            <div class="card-image"><img src="${scene.textures.getBase64('symbol3')}" alt=""></div>
          ...
          <div class="card">
            <div class="card-image"><img src="${scene.textures.getBase64('symbol4')}" alt=""></div>
          ...
          <div class="card">
            <div class="card-image"><img src="${scene.textures.getBase64('symbol5')}" alt=""></div>
          ...
          <div class="card">
            <div class="card-image"><img src="${scene.textures.getBase64('symbol6')}" alt=""></div>
          ...
          <div class="card">
            <div class="card-image"><img src="${scene.textures.getBase64('symbol7')}" alt=""></div>
          ...
          <div class="card">
            <div class="card-image"><img src="${scene.textures.getBase64('symbol8')}" alt=""></div>
            <div class="category"> BITCOIN </div>
            <div class="heading">5.&nbsp1370<br>4.&nbsp460&nbsp<br>3.&nbsp180&nbsp<br>2.&nbsp&nbsp&nbsp&nbsp&nbsp</div>
          </div>
          <div class="card">
            <div class="card-image"><img src="${scene.textures.getBase64('symbol9')}" alt=""></div>
            <div class="category"> BITCOIN </div>
            <div class="heading">5.&nbsp1370<br>4.&nbsp460&nbsp<br>3.&nbsp180&nbsp<br>2.&nbsp&nbsp&nbsp&nbsp&nbsp</div>
          </div>
          <div class="card">
            <div class="card-image"><img src="${scene.textures.getBase64('symbol10')}" alt=""></div>
            <div class="category"> BITCOIN </div>
            <div class="heading">5.&nbsp1370<br>4.&nbsp460&nbsp<br>3.&nbsp180&nbsp<br>2.&nbsp&nbsp&nbsp&nbsp&nbsp</div>
          </div>
        </div>
